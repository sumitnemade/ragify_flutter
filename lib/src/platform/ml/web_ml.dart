...
class WebML implements CrossPlatformML {
  ...
  Future<Map<String, dynamic>> makeApiCall(
    ...
    if (!_isInitialized) {
      throw Exception('WebML not initialized');
    }
